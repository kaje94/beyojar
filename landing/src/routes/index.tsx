            ...
            <main className="flex flex-col items-center justify-center bg-gray-50">
                    ...
                    <div className="px-3 w-full lg:w-2/5">
                        <div className="mx-auto mb-8 text-center lg:mx-0 lg:text-left">
                            ...
                            <h2 className="mb-4 text-2xl text-left lg:text-3xl">
                                An <span className="font-bold">open source</span> notes taking app to organize your life
                                better
                            </h2>
                        </div>

                        <div className=" items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                            <DownloadButton title="Download on the" subtitle="App Store" iconName="AppStore" />
                            <DownloadButton title="Download on" subtitle="Google Play" iconName="GooglePlay" />
                        </div>
                    </div>
                ...
                >
                    <div className="flex items-center mt-20 mb-10 ">
                        <h1 className="text-slate-900 text-5xl font-sans font-semibold drop-shadow-lg">Github</h1>
                    ...
                    <span className="text-center font-bold my-20 text-slate-800">
                        <a href="https://github.com/kaje94/beyojar" target="_blank">
                            <h2 className="text-2xl duration-300  hover:text-slate-500 drop-shadow-2xl">Source code</h2>
                        </a>
                        ...
                        <a href="https://github.com/kaje94/beyojar/issues/new" target="_blank">
                            <h2 className="text-2xl duration-300 hover:text-slate-500 drop-shadow-2xl">Report bug</h2>
                        </a>
                    </span>
                </section>
            </main>
                ...
                <div className="flex flex-wrap items-center">
                    <div className="grow-0 shrink-0 basis-auto w-full lg:w-4/12 mb-6 md:mb-0 px-3">
                        ...
                        <p className="text-gray-500 mb-12">
                            Beyojar has a number of features that makes it an awesome app to keep track of your notes
                        </p>
                    </div>

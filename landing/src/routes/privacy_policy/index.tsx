        ...
        <>
            <div className="flex flex-col items-center justify-center">
                <div className="container bg-gray-100 p-7 my-8 rounded-lg">
                    <h1 className="my-4 text-3xl text-left lg:text-4xl font-bold">Privacy Policy</h1>
                    <p className="font-thin">Last updated: October 24, 2022</p>
                    <p>
                    ...
                    <h2 className="mt-2 mb-1 text-2xl text-left lg:text-2xl">Types of Data Collected</h2>
                    <h3>Personal Data</h3>
                    <p>
                    ...
                    <h2 className="mt-2 mb-1 text-2xl text-left lg:text-2xl">Use of Your Personal Data</h2>
                    ...
                    <h2 className="mt-2 mb-1 text-2xl text-left lg:text-2xl">Retention of Your Personal Data</h2>
                    <p>
                    ...
                    <h2 className="mt-2 mb-1 text-2xl text-left lg:text-2xl">Transfer of Your Personal Data</h2>
                    <p>
                    ...
                    <h2 className="mt-2 mb-1 text-2xl text-left lg:text-2xl">Delete Your Personal Data</h2>
                    <p>
                    ...
                    <h2 className="mt-2 mb-1 text-2xl text-left lg:text-2xl">Disclosure of Your Personal Data</h2>
                    ...
                    <h2 className="mt-2 mb-1 text-2xl text-left lg:text-2xl">Security of Your Personal Data</h2>
                    <p>
                    ...
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">Children's Privacy</h1>
                    <p>
                    ...
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">Changes to this Privacy Policy</h1>
                    <p>
                    ...
                    <ul className="list-disc pl-3">
                        <li>By email: a.kajendran@gmail.com</li>
                    </ul>
                </div>
            </div>
            <Footer />

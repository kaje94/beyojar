        ...
        <>
            <div className="flex flex-col items-center justify-center">
                <div className="container bg-gray-100 p-7 my-8 rounded-lg">
                    <h1 className="my-4 text-3xl text-left lg:text-4xl font-bold">Terms and Conditions</h1>
                    <p className="font-thin">Last updated: October 19, 2022</p>
                    <p>Please read these terms and conditions carefully before using Our Service.</p>
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">Interpretation and Definitions</h1>
                    <h2 className="mt-2 mb-1 text-2xl text-left lg:text-2xl">Interpretation</h2>
                    <p>
                        The words of which the initial letter is capitalized have meanings defined under the following
                        conditions. The following definitions shall have the same meaning regardless of whether they
                        appear in singular or in plural.
                    </p>
                    <h2 className="mt-2 mb-1 text-2xl text-left lg:text-2xl">Definitions</h2>
                    <p>For the purposes of these Terms and Conditions:</p>
                    <ul className="list-disc pl-3">
                        <li>
                            <p>
                                <strong>Application</strong> means the software program provided by the Company
                                downloaded by You on any electronic device, named Beyojar
                            </p>
                        </li>
                        <li>
                            <p>
                        ...
                        <li>
                            <p>
                                ...
                                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Beyojar.
                            </p>
                        </li>
                        <li>
                            <p>
                    ...
                    <h1 className="my-4 text-3xl text-left lg:text-4xl">Acknowledgment</h1>
                    <p>
                    ...
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">Links to Other Websites</h1>
                    <p>
                    ...
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">Termination</h1>
                    <p>
                    ...
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">Limitation of Liability</h1>
                    <p>
                    ...
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">Governing Law</h1>
                    <p>
                    ...
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">Disputes Resolution</h1>
                    <p>
                    ...
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">For European Union (EU) Users</h1>
                    <p>
                    ...
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">United States Legal Compliance</h1>
                    <p>
                    ...
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">Severability and Waiver</h1>
                    <h2 className="mt-2 mb-1 text-2xl text-left lg:text-2xl">Severability</h2>
                    <p>
                    ...
                    <h2 className="mt-2 mb-1 text-2xl text-left lg:text-2xl">Waiver</h2>
                    <p>
                    ...
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">Translation Interpretation</h1>
                    <p>
                    ...
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">Changes to These Terms and Conditions</h1>
                    <p>
                    ...
                    <h1 className="mt-4 mb-2 text-3xl text-left lg:text-4xl">Contact Us</h1>
                    <p>If you have any questions about these Terms and Conditions, You can contact us:</p>
                    <ul className="list-disc pl-3">
                        <li>
                            <p>By email: a.kajendran@gmail.com</p>
                        </li>
                        <li>
                            <p>
